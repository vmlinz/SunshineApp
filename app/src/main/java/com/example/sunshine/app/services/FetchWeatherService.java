...
public class FetchWeatherService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_FETCH_WEATHER.equals(action)) {
                ...
                handleActionFetchWeather(location);
            }
        }
    }
     ...
     * @param location
     */
    private void handleActionFetchWeather(String location) {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                inserted = getApplicationContext().getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, array);
            }
